...
class admin extends db_connect
{
    ...
    public function setGhostValueForAccounts($ghost)
    {
        $ghost_create_at = 0;
        ...
        $stmt = $this->db->prepare("UPDATE users SET ghost = (:ghost), ghost_create_at = (:ghost_create_at)");
